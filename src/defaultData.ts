...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: 'cat-1783984034954', name: 'Cuidado Personal', slug: 'cuidado-personal', description: 'Productos esenciales para tu rutina diaria de belleza, higiene y salud. Todo lo que necesitas para tu cuidado personal en un solo lugar.' }
];

export const DEFAULT_CONFIG: SiteConfig = {
  siteName: 'Weily',
  whatsappPhone: '+50487563605',
  currencySymbol: 'Lps.'
};
